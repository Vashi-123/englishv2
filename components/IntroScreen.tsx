...
export const IntroScreen: React.FC<IntroScreenProps> = ({ onNext }) => {
  ...
  const renderPriceModal = () => {
    ...
    return createPortal(
      <div className="fixed inset-0 z-[120] flex items-center justify-center px-4 sm:px-6 bg-black/60 overflow-y-auto">
        <div className="relative w-full max-w-lg rounded-3xl bg-white border border-gray-200 shadow-2xl p-6 sm:p-8 my-8">
          <button
            type="button"
            onClick={() => {
              if (paying) return;
            ...
            <div className="pt-5 border-t border-gray-100 space-y-4">
              <div>
                ...
                <input
                  ...
                  disabled={paying}
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-brand-primary focus:ring-2 focus:ring-brand-primary/20 outline-none transition disabled:opacity-50 disabled:cursor-not-allowed"
                  onKeyDown={(e) => {
