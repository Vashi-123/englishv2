...
export function ExerciseCard({ kind, content, renderMarkdown, completed, showCompletionBadge = true }: Props) {
  const borderClass = kind === 'text' ? 'border-brand-primary/60' : 'border-brand-primary/40';
  return (
    <div className="space-y-4">
      <div className={`p-5 rounded-3xl border ${borderClass} bg-white shadow-[0_24px_80px_rgba(99,102,241,0.28)] space-y-4 w-full max-w-2xl mx-auto`}>
