...
export function ExerciseCard({ kind, content, renderMarkdown, completed, showCompletionBadge = true }: Props) {
  const borderClass = kind === 'text' ? 'border-brand-primary/60' : 'border-gray-200/60';
  return (
    <div className="space-y-4">
      <div className={`p-5 rounded-3xl border ${borderClass} bg-white shadow-lg shadow-slate-900/10 space-y-4 w-full max-w-2xl mx-auto`}>
