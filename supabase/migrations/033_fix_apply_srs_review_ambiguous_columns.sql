-- Fix Postgres 42702: ambiguous column names in UPDATE because RETURNS TABLE
-- output columns become plpgsql variables. Qualify table columns in the SET
-- clause to avoid conflicts (review_count, correct_count, wrong_count, streak).
